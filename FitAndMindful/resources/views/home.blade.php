            ...
            <div class="flex flex-col items-start">
                ...
                <div class="w-[55vw]">
                    <div class="text-[#c2c5aa] text-center flex flex-col w-full">
                        ...
                        <p class="text-[24px] text-[#b6ad90] font-cardo font-bold mb-10 ml-2 w-full transform scale-y-[1.4] scale-x-[1.4]">
                            APP FOR YOUR PHYSICAL MENTAL<br>HEALTH
                        </p>
                        <button class="bg-[#f5f5f5] text-[#656d4a] rounded-[50px] text-[16px] px-16 py-6 self-center font-semibold">
                            SIGN IN
                        </button>
                    </div>
                </div>
        ...
        <div class="relative mt-48 ml-32">
            ...
            <div class="absolute top-0 left-[45%]">
                <img src="{{ asset('images/HomPage/workoutPurpose.png') }}"
                     class="w-[220px] h-[300px] object-cover rounded-[1.5rem] scale-[1.3]"/>
            </div>
        ...
        <div class="relative mt-80 w-full flex flex-col items-center">
            ...
            <div class="grid grid-cols-3 gap-x-[6vw] gap-y-20 justify-items-center w-full max-w-[1600px]">
                <a href="#" class="flex flex-col items-center transform scale-[1.2]">
                    <img src="{{ asset('images/HomPage/WokoutPlansOffer.png') }}"
                         class="w-[250px] h-[350px] object-cover rounded-[1.5rem]" />
                ...
                <a href="#" class="flex flex-col items-center transform scale-[1.2]">
                    <img src="{{ asset('images/HomPage/DietOffer.jpg') }}"
                         class="w-[250px] h-[350px] object-cover rounded-[1.5rem]" />
                    <p class="font-hk text-[28px] text-[#f5f5f5] mt-4 text-center font-semibold">
                        Healthy receipes
                    </p>
                ...
                <a href="#" class="flex flex-col items-center transform scale-[1.2]">
                    <img src="{{ asset('images/HomPage/MentalHealthOffer.jpg') }}"
                         class="w-[250px] h-[350px] object-cover rounded-[1.5rem]" />
                    <p class="font-hk text-[28px] text-[#f5f5f5] mt-4 text-center font-semibold">
                        Mental Health
                    </p>
                ...
                <div class="col-span-3 flex justify-center gap-[12vw] mt-20">
                    <a href="#" class="flex flex-col items-center transform scale-[1.2]">
                        <img src="{{ asset('images/HomPage/large-AdobeStock_334093559.jpeg') }}"
                             class="w-[250px] h-[350px] object-cover rounded-[1.5rem]" />
                        <p class="font-hk text-[28px] text-[#f5f5f5] mt-4 text-center font-semibold">
                            Food Diary
                        </p>
                    ...
                    <a href="#" class="flex flex-col items-center transform scale-[1.2]">
                        <img src="{{ asset('images/HomPage/journalOffer.jpg') }}"
                             class="w-[250px] h-[350px] object-cover rounded-[1.5rem]" />
                        <p class="font-hk text-[28px] text-[#f5f5f5] mt-4 text-center font-semibold">
                            Journal
                        </p>
